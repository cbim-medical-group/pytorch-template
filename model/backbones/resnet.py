...
def ResNet50(num_classes=10, in_channel=3):
    return ResNet(Bottleneck, [3,4,6,3],num_classes, in_channel)

def ResNet101(num_classes=10, in_channel=3):
    return ResNet(Bottleneck, [3,4,23,3],num_classes, in_channel)

def ResNet152(num_classes=10, in_channel=3):
    return ResNet(Bottleneck, [3,8,36,3],num_classes, in_channel)
