...
class SimpleVaeLinear2(nn.Module):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super(SimpleVaeLinear2, self).__init__()
    ...
    def decode(self, z: Tensor) -> Tensor:
        ...
        z = self.upsampler(result)

        z = z.view(-1, 32, self.last_layer_size*2, self.last_layer_size*2)
